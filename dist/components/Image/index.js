...
var _requestAnimationFrame=require('fbjs/lib/requestAnimationFrame');var _requestAnimationFrame2=_interopRequireDefault(_requestAnimationFrame);var _jss=require('../../apis/StyleSheet/jss.js');var _jss2=_interopRequireDefault(_jss);
...
var styles=_jss2.default.create({
initial:{
...
var resizeModeStyles=_jss2.default.create({
center:{
backgroundSize:'auto',
backgroundPosition:'center'},
