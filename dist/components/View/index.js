...
var _normalizeNativeEvent=require('../../modules/normalizeNativeEvent');var _normalizeNativeEvent2=_interopRequireDefault(_normalizeNativeEvent);var _jss=require('../../apis/StyleSheet/jss.js');var _jss2=_interopRequireDefault(_jss);
...
var flattenedStyle=_jss2.default.flatten(style);
...
props[handlerName]=_this2._normalizeEventForHandler(handler);
}
return props;
},otherProps);
